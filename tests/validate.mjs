...
import { buildCountingMadhhabAyahs, buildDifferingAyahSummary } from '../scripts/lib/mushaf-viewer.mjs';
...
const siteData = loadDist('site-data.json');
const mushafViewerDir = distPath('mushaf');
...
assert(existsSync(mushafViewerDir), 'dist/mushaf exists');
