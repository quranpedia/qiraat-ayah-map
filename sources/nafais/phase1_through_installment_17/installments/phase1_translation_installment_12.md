# Phase 1 Translation — Installment 12

Work: **Nafa'is al-Bayan — Commentary on al-Fara'id al-Hisan**

Scope: book pages 42–43; Surat al-Isra'; Surat al-Kahf.
...
- This source heading covers two surahs together; the shared title is preserved, while the later segments are assigned to Surat al-Kahf where the commentary is confined to it.
- The opening poem/commentary unit moves from Surat al-Isra' to Surat al-Kahf in a single segment, so it is preserved as a shared segment.
- The authorial footnote explaining the analogy between zar'an and abadan is preserved as a separate technical note segment.
