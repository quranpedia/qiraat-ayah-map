# Phase 1 Translation — Installment 17

Work: **Nafa'is al-Bayan — Commentary on al-Fara'id al-Hisan**

Scope: book pages 49; Surat al-Shu'ara'.
...
- The restrictive qualifiers 'first' and 'third' are preserved explicitly because the commentator uses them to distinguish repeated occurrences of the same terminal word within the surah.
...
- The closing tanbih that adds {Ta Sin Mim} as a fourth disputed place is separated as a technical note segment for easier later extraction.
