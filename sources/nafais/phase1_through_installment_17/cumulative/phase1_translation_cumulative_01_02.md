# Phase 1 Translation — Cumulative (Installments 01–02)

Work: **Nafa'is al-Bayan — Commentary on al-Fara'id al-Hisan**

Scope: book pages 22–31; Madkhal / Introduction; Surat al-Fatihah; Surat al-Baqarah.

Translation register: technical, literal, readable.

Source note:
- The Arabic source in this installment has been lightly normalized where the OCR was plainly unstable and the intended reading is fixed by the prose commentary.
